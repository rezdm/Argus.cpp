...
class test_result {
 ...
 public:
  // Constructors
  test_result(bool success_val, long duration_ms_val, std::chrono::system_clock::time_point timestamp_val, const std::optional<std::string>& error_val = std::nullopt);
