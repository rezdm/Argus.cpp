...
void test_config::set_test_method(const test_method method) {
    test_method_type_ = method;
}

void test_config::set_protocol(protocol proto) {
    protocol_type_ = proto;
}

void test_config::clear_protocol() {
...
void test_config::clear_url() {
    url_.reset();
}

void test_config::set_proxy(const std::string& proxy_val) {
    proxy_ = proxy_val;
}

void test_config::clear_proxy() {
    proxy_.reset();
}
